...
mysql_query("INSERT INTO `$roadsdb` (`id`, `hash`, `user`, `classes`, `major`, `public`, `ip`, `added`) (SELECT NULL, '{$_SESSION['saveas']}', '$athena', `classes`, `major`, `public`, `ip`, CURRENT_TIMESTAMP FROM `$roadsdb` WHERE `hash`='{$_SESSION['crhash']}' AND `classes` != '[]' ORDER BY `added` DESC LIMIT 0,1)");
