  ...
  var temp139 = function () {
    ...
    road.coursesOfStudy = ['girs',] + majors.map((m) => {
      return {
        ...
        m3_A: 'major3a',
        m3_C: 'major3c',
        m4_archdesign: 'major4b',
        m4_buildingtech: 'major4',
        m4_computation: 'major4',
        m4_history: 'major4',
        m4_artculture: 'major4',
        m4_new: 'major4',
        m4_B: 'major4b',
        m5: 'major5',
        m6_1: 'major6-1',
        m6_1_new: 'major6-1',
        m6_1_8_flex: 'major8flex',
        m6_2: 'major6-2',
        m6_2_new: 'major6-2',
        m6_3: 'major6-3',
        m6_3_new: 'major6-3',
        ...
        m16_ENG: 'major16-ENG',
        m17: 'major17',
        m18_general: 'major18gm',
        m18_applied: 'major18am',
        m18_theoretical: 'major18pm',
        m18_C: 'major18c',
        m20: 'major20',
        m21: 'major21a',
        m21_german: 'majorGerman',
        m21_A: 'major21a',
        m21_E: 'major21e',
        m21_F_french: 'majorFrench',
        m21_F_spanish: 'majorSpanish',
        m21_G_french: 'majorFrench',
        m21_G_spanish: 'majorSpanish',
        m21_H: 'major21h',
        m21_L: 'major21L',
        m21_M: 'major21M-1',
        m21_M_2: 'major21M-2',
        m21_S: 'major21S',
        m21_W_creative: 'major21WCre',
        m21_W_science: 'major21WSci',
        m21_W_digital: 'major21WDig',
        m22_old: 'major22',
        m22: 'major22',
        m24_1: 'major24-1',
        m24_2_linguistics: 'major24-2Ling',
        m24_2_philosophy: 'major24-2Phil',
        mCMS: 'majorCMS',
        mSTS: 'majorSTS',
        mWGS: 'majorWGS',
        miComputerScience: 'minor6',
        miArchitecture: 'minorArchitecture',
        miDesign: 'minorDesign',
        miEntrepreneurship_Innovation: 'minorEI',
        miHist_Architecture_Art: 'minorHistAAD',
        miArt_culture_tech: 'minorACT',
        miUrban_studies_and_planning: 'minor11',
        miInternational_development: 'minorIDev',
        miToxicology_and_enviro_health: 'minor20',
        miCivil_Engineering: 'minor1ce',
        miEnvrio_Engineering_Science: 'minor1ees',
        miAnthropology: 'minor21A',
        miCMS: 'minorCMS',
        miBiology: 'minor7',
        miBrain_Cog_Sci: 'minor9',
        miChemistry: 'minor5',
        miEarth_Atmos_Planetary: 'minor12',
        miAtmospheric_chemistry: 'minorAtChem',
        miEcon: 'minor14',
        mi15_1: 'minor15Mgmt',
        mi15_2: 'minor15BA',
        mi15_3: 'minor15F',
        miStatistics: 'minorSDS',
        miWriting: 'minor21W',
        miManagement: 'minor15Mgmt',
        miManagement_science: 'minor15Mgmt',
        miSTS: 'minorSTS',
        miMusic: 'minor21m',
        miTheater_arts: 'minor21M-2',
        miPhilosophy: 'minor24-1',
        miLinguistics: 'minor24-2',
        miMSE: 'minor3',
        miArchaeology: 'minor3c',
        miMathematics: 'minor18',
        miMechE: 'minor2',
        miNuclear_science: 'minor22',
        miPhysics: 'minor8',
        miPolitical_science: 'minor17',
        miChinese: 'minorChinese',
        mi21_G_chinese: 'minorChinese',
        miFrench: 'minorFrench',
        mi21_G_french: 'minorFrench',
        miGerman: 'minorGerman',
        miSpanish: 'minorSpanish',
        mi21_G_spanish: 'minorSpanish',
        miJapanese: 'minorJapanese',
        miAsian: 'minorAADS',
        miHistory: 'minor21H',
        miLiterature: 'minor21L',
        miAncient_and_medieval: 'minorAMS',
        miApplied_international: 'minorAIS',
        miPremed: 'prehealth',
        miAstronomy: 'minorAstro',
        miBiomed: 'minorBME',
        miEnergy_studies: 'minorES',
        miPsych: 'minor9',
        miPublic_policy: 'minorPublicPol',
        miWGS: 'minorWGS',
        miRussian_Eurasian_studies: 'minorRussian',
        neAutonomous_Machines: 'neetAM',
        neLiving_Machines: 'neetLM',
